    ...
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Detalhe(Guid id, string? tab)
        {
            ...
            var vm = new ClienteDetalheViewModel
            {
                ...
                PropostasRascunho   = propostaItems.Count(p => p.StatusProposta == StatusProposta.Rascunho),
                PropostasRejeitadas = propostaItems.Count(p => p.StatusProposta == StatusProposta.Rejeitada),
                PropostasCanceladas = propostaItems.Count(p => p.StatusProposta == StatusProposta.Cancelada),
